...
// =========================================================
// LIMITS SCREEN v6.1 — Direct Transf'air
...
import { api } from "../../../services/api"; // ✅ v6.1
...
const KYC_COLOR: Record<string, string> = { LEVEL_0: T.amber, LEVEL_1: T.accent, LEVEL_2: T.blue, LEVEL_3: T.purple };
const KYC_BG:    Record<string, string> = { LEVEL_0: "#FEF3C7", LEVEL_1: T.accentLight, LEVEL_2: T.blueBg, LEVEL_3: T.purpleBg };
...
const s = StyleSheet.create({
  ...
  backBtn:     { width: 40, height: 40, borderRadius: T.radius.md, backgroundColor: T.cardBg, justifyContent: "center", alignItems: "center", borderWidth: 1, borderColor: T.border, ...T.shadow },
  ...
  kycCard:     { backgroundColor: T.cardBg, borderRadius: T.radius.lg, padding: 16, marginBottom: 20, borderWidth: 1, borderColor: T.border, shadowColor: "#000", shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.06, shadowRadius: 4, elevation: 2 },
  ...
  requestBtn:  { flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 8, paddingVertical: 16, borderRadius: T.radius.md, marginTop: 8 },
