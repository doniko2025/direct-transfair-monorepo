...
// =========================================================
// PERSONAL INFO — SUPER ADMIN v5.1
  ...
  return (
    <View style={[{ marginBottom: 14 }, style]}>
      ...
      <View style={[fS.box, focused && fS.boxFocused, !editable && fS.boxDisabled]}>
        ...
        />
        {!editable && <View style={fS.lockBadge}><Ionicons name="lock-closed" size={11} color={T.textDim} /></View>}
      </View>
    </View>
  );
}
...
function SectionHeader({ icon, title }: { icon: string; title: string }) {
  return (
    <View style={{ flexDirection: "row", alignItems: "center", gap: 8, marginBottom: 16 }}>
      ...
      <Text style={{ fontSize: 11, fontWeight: "900", color: T.textSub, letterSpacing: 1.5, fontFamily: T.font.sans }}>
        {title}
      </Text>
    </View>
  );
      ...
      <KeyboardAvoidingView behavior={Platform.OS === "ios" ? "padding" : undefined} style={{ flex: 1 }}>
        <ScrollView
          contentContainerStyle={{
            ...
            paddingTop: 8,
            paddingBottom: 100,  // ✅ Fix masquage tab bar
          }}
