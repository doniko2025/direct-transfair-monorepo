...
// ⚠️ Adaptez l'IP si besoin (ex: votre IP locale si vous testez sur téléphone physique)
const LOCAL_IP = "localhost";

import type {
  LoginPayload, LoginResponse, RegisterPayload, Beneficiary, CreateBeneficiaryPayload,
  Transaction, CreateTransactionPayload, InitiatePaymentPayload, UpdateWithdrawalStatusPayload,
  AuthUser, Agency, CreateAgencyPayload
} from "./types";
